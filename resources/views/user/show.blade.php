...
@section("content")
    <div class="col-sm-8">
        <blockquote>
            ...
            <footer>フォロー：{{$user->stars_count}}｜フォロワー：{{$user->fans_count}}｜文章：{{$user->posts_count}}</footer>
    ...
    <div class="col-sm-8 blog-main">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class=""><a href="#tab_2" data-toggle="tab" aria-expanded="false">フォロー</a></li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tab_2">
                    ...
                    <div class="blog-post" style="margin-top: 30px">
                        <p class="">{{$user->name}}</p>
                        <p class="">フォロー：{{$user->stars_count}} | フォロワー：{{$user->fans_count}}｜ 文章：{{$user->posts_count}}</p>
