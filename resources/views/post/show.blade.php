...
@section("content")
        <div class="col-sm-8 blog-main">
            <div class="blog-post">
                ...
                <div>
                    @if($post->zan(\Auth::id())->exists())
                        <a href="/posts/{{$post->id}}/unzan" type="button" class="btn btn-default btn-lg">いいね！キャンセル</a>
                    @else
            ...
            <div class="panel panel-default">
                <!-- Default panel contents -->
                <div class="panel-heading">コメントします</div>
                    ...
                    <form action="/posts/{{$post->id}}/comment" method="POST">
                       {{csrf_field()}}
                        <li class="list-group-item">
                            ...
                            <button class="btn btn-default" type="submit">提出</button>
                        </li>
                    </form>
