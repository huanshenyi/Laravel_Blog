        ...
        <div class="col-sm-8 blog-main">
                ...
                <div id="carousel-example" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <img src="{{ \Illuminate\Support\Facades\URL::asset('img/go.jpg') }}" alt="..." />
                            <div class="carousel-caption">...</div>
                        </div>
                        <div class="item">
                            <img src="{{URL::asset('img/dockers.png')}}" alt="..." />
                            <div class="carousel-caption">...</div>
                        </div>
                        <div class="item">
            ...
            <div>
                ...
                <div class="blog-post">
                    ...
                    <p class="blog-post-meta">いいね！ {{$post->zans_count}}  | コメント数 {{$post->comments_count}}</p>
                </div>
               @endforeach
